...
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$y             Telegram : https://www.snapchat.com/add/yoo_prasad?share_id=UowCmK-eEjM&locale=en-PL $wh"
echo -e "$y           Premium Auto Script By YooAzkaban $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo ""
echo -e "$y SSH & OpenVPN $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$yy 1$y.Create SSH & OpenVPN UserLogin"
echo -e "$yy 2$y.Generate SSH & OpenVPN Trial UserLogin"
